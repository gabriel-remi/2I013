...
public class Ecosystem extends JPanel implements KeyListener{
	...
	//probabilités concernant les arbres
	...
	//variables pour intéractions avec le clavier
	boolean key_zone, key_aggro, key_season, key_lava, key_rain;
	...
	private final static int INIT_PLAYER_NUMBER = 1;
	...
	private void initAgents() {
		...
		createPlayer(Ecosystem.INIT_PLAYER_NUMBER);
		createRobot();

	}
	
	private void createRobot() {
		agents.add(new Robot(5, 5));

	}
	
	private void createPlayer(int numberPlayer) {
		for (int i = 1; i <= numberPlayer; i++) {
			Ecosystem.agents.add(new Player(Ecosystem.spawn_pos.x, Ecosystem.spawn_pos.y));
	...
	private void update() {
		...
		/*
		 * update the logic of the ecosytem environment, go to the worldmap class to see
		 * how it's updated : fire spreading, water flowing, ashes diasappearing ...
		 */
		updateSeason();
		map.update();
		// update the logic of the agents, scroll down to the bottom
		updateAgents();
			...
			if (a.life > 0) {
				if (a instanceof Robot) {
					...
					g2.fillOval((robot.cur_pos.x - robot.detection_area) * Ecosystem.SPRITE_SIZE,
							...
							robot.detection_area * Ecosystem.SPRITE_SIZE * 2, Ecosystem.SPRITE_SIZE * robot.detection_area * 2);
				...
				if (a instanceof Player) {
					...
					g2.fillOval((player.cur_pos.x - player.detection_area) * Ecosystem.SPRITE_SIZE,
							...
							player.detection_area * Ecosystem.SPRITE_SIZE * 2, Ecosystem.SPRITE_SIZE * player.detection_area * 2);
				...
				if (a instanceof MiniRobot) {
					...
					g2.fillOval((int)((minirobot.cur_pos.x - minirobot.detection_area + 0.5) * Ecosystem.SPRITE_SIZE),
							...
							minirobot.detection_area * Ecosystem.SPRITE_SIZE * 2, Ecosystem.SPRITE_SIZE * minirobot.detection_area * 2);
				}
			}
		}
...
/////////////////////////////////////////////////////////////////////////
		...
		for (int x = 0; x < map.getMapTexture().length; x++) {
			for (int y = 0; y < map.getMapTexture()[0].length; y++) {
				...
				case MapTextureID.SPAWN:
					g2.drawImage(SpriteLoader.loader.spawn[0], (Ecosystem.spawn_pos.x - 1) * Ecosystem.SPRITE_SIZE,
	...
	private void draw_spring_ground(Graphics g2, int x, int y) {
		if(map.getTextureLeft(x,y) == MapTextureID.WATER)
			g2.drawImage(SpriteLoader.loader.spring_shore_right, x * SPRITE_SIZE, y * SPRITE_SIZE,
				SPRITE_SIZE, SPRITE_SIZE, this);
		else if(map.getTextureRight(x,y) == MapTextureID.WATER)
		g2.drawImage(SpriteLoader.loader.spring_shore_left, x * SPRITE_SIZE, y * SPRITE_SIZE,
			SPRITE_SIZE, SPRITE_SIZE, this);
		else if(map.getTextureUp(x,y) == MapTextureID.WATER)
		g2.drawImage(SpriteLoader.loader.spring_shore_down, x * SPRITE_SIZE, y * SPRITE_SIZE,
			SPRITE_SIZE, SPRITE_SIZE, this);
		else if(map.getTextureDown(x, y) == MapTextureID.WATER)
		g2.drawImage(SpriteLoader.loader.spring_shore_up, x * SPRITE_SIZE, y * SPRITE_SIZE,
			SPRITE_SIZE, SPRITE_SIZE, this);
		else
		...
		private void draw_spring_corner_shore_A(Graphics g2,int x,int y) {
			...
			case 0:
				g2.drawImage(SpriteLoader.loader.ssc_bottom_left, x * SPRITE_SIZE, y * SPRITE_SIZE,
						SPRITE_SIZE, SPRITE_SIZE, this);
				break;
			case 1:
				g2.drawImage(SpriteLoader.loader.ssc_bottom_right, x * SPRITE_SIZE, y * SPRITE_SIZE,
						SPRITE_SIZE, SPRITE_SIZE, this);
				break;
			case 2:
				g2.drawImage(SpriteLoader.loader.ssc_top_right, x * SPRITE_SIZE, y * SPRITE_SIZE,
						SPRITE_SIZE, SPRITE_SIZE, this);
				break;
			case 3:
				g2.drawImage(SpriteLoader.loader.ssc_top_left, x * SPRITE_SIZE, y * SPRITE_SIZE,
						SPRITE_SIZE, SPRITE_SIZE, this);
				break;
			}
		}
		...
		private void draw_spring_corner_shore_B(Graphics g2,int x,int y) {
			...
			case 0:
				g2.drawImage(SpriteLoader.loader.ssc_top_left_B, x * SPRITE_SIZE, y * SPRITE_SIZE,
						SPRITE_SIZE, SPRITE_SIZE, this);
				break;
			case 1:
				g2.drawImage(SpriteLoader.loader.ssc_top_right_B, x * SPRITE_SIZE, y * SPRITE_SIZE,
						SPRITE_SIZE, SPRITE_SIZE, this);
				break;
			case 2:
				g2.drawImage(SpriteLoader.loader.ssc_bottom_left_B, x * SPRITE_SIZE, y * SPRITE_SIZE,
						SPRITE_SIZE, SPRITE_SIZE, this);
				break;
			case 3:
				g2.drawImage(SpriteLoader.loader.ssc_bottom_right_B, x * SPRITE_SIZE, y * SPRITE_SIZE,
						SPRITE_SIZE, SPRITE_SIZE, this);
				break;
			}
		}
...
/////////////////////////////////////////////////////////////////////////
				...
				for (int y = 0; y < map.getMapTexture()[0].length; y++) {
					...
					case MapTextureID.GROUND:
						if(map.getMapTexture()[x][y] == MapTextureID.WATER) {
							g2.drawImage(SpriteLoader.loader.water, x * SPRITE_SIZE, y * SPRITE_SIZE,
									SPRITE_SIZE, SPRITE_SIZE, this);
						}else {
							if(map.is_corner_B(x,y))
		...
		private void draw_summer_ground(Graphics g2, int x, int y) {
			if(map.getTextureLeft(x,y) == MapTextureID.WATER)
				g2.drawImage(SpriteLoader.loader.summer_shore_left, x * SPRITE_SIZE, y * SPRITE_SIZE,
					SPRITE_SIZE, SPRITE_SIZE, this);
			else if(map.getTextureRight(x,y) == MapTextureID.WATER)
			g2.drawImage(SpriteLoader.loader.summer_shore_up, x * SPRITE_SIZE, y * SPRITE_SIZE,
				SPRITE_SIZE, SPRITE_SIZE, this);
			else if(map.getTextureDown(x, y) == MapTextureID.WATER)
			g2.drawImage(SpriteLoader.loader.summer_shore_down, x * SPRITE_SIZE, y * SPRITE_SIZE,
				SPRITE_SIZE, SPRITE_SIZE, this);
			else if(map.getTextureUp(x, y) == MapTextureID.WATER)
			g2.drawImage(SpriteLoader.loader.summer_shore_right, x * SPRITE_SIZE, y * SPRITE_SIZE,
				SPRITE_SIZE, SPRITE_SIZE, this);
			else
			...
			private void draw_summer_corner_shore_A(Graphics g2,int x,int y) {
				switch(map.select_corner_typeA(x, y)) {
				case 0:
					g2.drawImage(SpriteLoader.loader.sum_sc_top_right, x * SPRITE_SIZE, y * SPRITE_SIZE,
							SPRITE_SIZE, SPRITE_SIZE, this);
					break;
				case 1:
					g2.drawImage(SpriteLoader.loader.sum_sc_bottom_right, x * SPRITE_SIZE, y * SPRITE_SIZE,
							SPRITE_SIZE, SPRITE_SIZE, this);
					break;
				case 2:
					g2.drawImage(SpriteLoader.loader.sum_sc_bottom_left, x * SPRITE_SIZE, y * SPRITE_SIZE,
							SPRITE_SIZE, SPRITE_SIZE, this);
					break;
				case 3:
					g2.drawImage(SpriteLoader.loader.sum_sc_top_left, x * SPRITE_SIZE, y * SPRITE_SIZE,
							SPRITE_SIZE, SPRITE_SIZE, this);
					break;
				}
			}
			...
			private void draw_summer_corner_shore_B(Graphics g2,int x,int y) {
				switch(map.select_corner_typeB(x, y)) {
				case 0:
					g2.drawImage(SpriteLoader.loader.sum_sc_bottom_right_B, x * SPRITE_SIZE, y * SPRITE_SIZE,
							SPRITE_SIZE, SPRITE_SIZE, this);
					break;
				case 1:
					g2.drawImage(SpriteLoader.loader.sum_sc_top_right_B, x * SPRITE_SIZE, y * SPRITE_SIZE,
							SPRITE_SIZE, SPRITE_SIZE, this);
					break;
				case 2:
					g2.drawImage(SpriteLoader.loader.sum_sc_bottom_left_B, x * SPRITE_SIZE, y * SPRITE_SIZE,
							SPRITE_SIZE, SPRITE_SIZE, this);
					break;
				case 3:
					g2.drawImage(SpriteLoader.loader.sum_sc_top_left_B, x * SPRITE_SIZE, y * SPRITE_SIZE,
							SPRITE_SIZE, SPRITE_SIZE, this);
					break;
				}
			}
...
private void draw_fall_ground(Graphics g2, int x, int y) {
	if(map.getTextureLeft(x,y) == MapTextureID.WATER)
		g2.drawImage(SpriteLoader.loader.fall_shore_down, x * SPRITE_SIZE, y * SPRITE_SIZE,
				SPRITE_SIZE, SPRITE_SIZE, this);
	else if(map.getTextureRight(x, y) == MapTextureID.WATER)
		g2.drawImage(SpriteLoader.loader.fall_shore_up, x * SPRITE_SIZE, y * SPRITE_SIZE,
				SPRITE_SIZE, SPRITE_SIZE, this);
	else if(map.getTextureDown(x, y) == MapTextureID.WATER)
		g2.drawImage(SpriteLoader.loader.fall_shore_left, x * SPRITE_SIZE, y * SPRITE_SIZE,
				SPRITE_SIZE, SPRITE_SIZE, this);
	else if(map.getTextureUp(x, y) == MapTextureID.WATER)
		g2.drawImage(SpriteLoader.loader.fall_shore_right, x * SPRITE_SIZE, y * SPRITE_SIZE,
				SPRITE_SIZE, SPRITE_SIZE, this);
	else
...
private void draw_fall_corner_shore_A(Graphics g2,int x,int y) {
	switch(map.select_corner_typeA(x, y)) {
	case 0:
		g2.drawImage(SpriteLoader.loader.fsc_top_right, x * SPRITE_SIZE, y * SPRITE_SIZE,
				SPRITE_SIZE, SPRITE_SIZE, this);
		break;
	case 1:
		g2.drawImage(SpriteLoader.loader.fsc_top_left, x * SPRITE_SIZE, y * SPRITE_SIZE,
				SPRITE_SIZE, SPRITE_SIZE, this);
		break;
	case 2:
		g2.drawImage(SpriteLoader.loader.fsc_bottom_left, x * SPRITE_SIZE, y * SPRITE_SIZE,
				SPRITE_SIZE, SPRITE_SIZE, this);
		break;
	case 3:
		g2.drawImage(SpriteLoader.loader.fsc_bottom_right, x * SPRITE_SIZE, y * SPRITE_SIZE,
				SPRITE_SIZE, SPRITE_SIZE, this);
		break;
	}
}
...
private void draw_fall_corner_shore_B(Graphics g2,int x,int y) {
	switch(map.select_corner_typeB(x, y)) {
	case 0:
		g2.drawImage(SpriteLoader.loader.fsc_top_left_B, x * SPRITE_SIZE, y * SPRITE_SIZE,
				SPRITE_SIZE, SPRITE_SIZE, this);
		break;
	case 1:
		g2.drawImage(SpriteLoader.loader.fsc_top_right_B, x * SPRITE_SIZE, y * SPRITE_SIZE,
				SPRITE_SIZE, SPRITE_SIZE, this);
		break;
	case 2:
		g2.drawImage(SpriteLoader.loader.fsc_bottom_left_B, x * SPRITE_SIZE, y * SPRITE_SIZE,
				SPRITE_SIZE, SPRITE_SIZE, this);
		break;
	case 3:
		g2.drawImage(SpriteLoader.loader.fsc_bottom_right_B, x * SPRITE_SIZE, y * SPRITE_SIZE,
				SPRITE_SIZE, SPRITE_SIZE, this);
		break;
	}
}
...
private void drawMapTextureWinter(Graphics2D g2) {
	...
	private void draw_winter_corner_shore_B(Graphics g2,int x,int y) {
		switch(map.select_corner_typeB(x, y)) {
		case 0:
			g2.drawImage(SpriteLoader.loader.wsc_bottom_right_B, x * SPRITE_SIZE, y * SPRITE_SIZE,
				SPRITE_SIZE, SPRITE_SIZE, this);
			break;
		case 1:
			g2.drawImage(SpriteLoader.loader.wsc_top_right_B, x * SPRITE_SIZE, y * SPRITE_SIZE,
				SPRITE_SIZE, SPRITE_SIZE, this);
			break;
		case 2:
			g2.drawImage(SpriteLoader.loader.wsc_bottom_left_B, x * SPRITE_SIZE, y * SPRITE_SIZE,
				SPRITE_SIZE, SPRITE_SIZE, this);
			break;
		case 3:
			g2.drawImage(SpriteLoader.loader.wsc_top_left_B, x * SPRITE_SIZE, y * SPRITE_SIZE,
				SPRITE_SIZE, SPRITE_SIZE, this);
			break;
		}
	}
	...
	private void draw_winter_corner_shore_A(Graphics g2,int x,int y) {
		switch(map.select_corner_typeA(x, y)) {
		case 0:
			g2.drawImage(SpriteLoader.loader.wsc_top_right, x * SPRITE_SIZE, y * SPRITE_SIZE,
					SPRITE_SIZE, SPRITE_SIZE, this);
			break;
		case 1:
			g2.drawImage(SpriteLoader.loader.wsc_bottom_right, x * SPRITE_SIZE, y * SPRITE_SIZE,
					SPRITE_SIZE, SPRITE_SIZE, this);
			break;
		case 2:
			g2.drawImage(SpriteLoader.loader.wsc_bottom_left, x * SPRITE_SIZE, y * SPRITE_SIZE,
					SPRITE_SIZE, SPRITE_SIZE, this);
			break;
		case 3:
			g2.drawImage(SpriteLoader.loader.wsc_top_left, x * SPRITE_SIZE, y * SPRITE_SIZE,
					SPRITE_SIZE, SPRITE_SIZE, this);
			break;
		}
	}
...
private void draw_winter_ground(Graphics g2, int x, int y) {
	if(map.getMapTexture()[(x+1 + map.getHeight())%map.getHeight()][y] == MapTextureID.WATER)
			g2.drawImage(SpriteLoader.loader.winter_shore_left, x * SPRITE_SIZE, y * SPRITE_SIZE,
					SPRITE_SIZE, SPRITE_SIZE, this);
	else if(map.getMapTexture()[(x-1 + map.getHeight())%map.getHeight()][y] == MapTextureID.WATER)
			g2.drawImage(SpriteLoader.loader.winter_shore_right, x * SPRITE_SIZE, y * SPRITE_SIZE,
					SPRITE_SIZE, SPRITE_SIZE, this);
	else if(map.getMapTexture()[x][(y-1 + map.getWidth())%map.getWidth()] == MapTextureID.WATER)
			g2.drawImage(SpriteLoader.loader.winter_shore_down, x * SPRITE_SIZE, y * SPRITE_SIZE,
					SPRITE_SIZE, SPRITE_SIZE, this);
	else if(map.getMapTexture()[x][(y+1  + map.getWidth())%map.getWidth()] == MapTextureID.WATER)
		g2.drawImage(SpriteLoader.loader.winter_shore_up, x * SPRITE_SIZE, y * SPRITE_SIZE,
				SPRITE_SIZE, SPRITE_SIZE, this);
	else
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		for (int x = 0; x < map.getMapEntities().length; x++) {
			for (int y = 0; y < map.getMapEntities()[0].length; y++) {
				...
				case MapEntitiesID.BABY_GREEN_TREE:
					g2.drawImage(SpriteLoader.loader.tree, x * SPRITE_SIZE + (SPRITE_SIZE/2), y * SPRITE_SIZE + (SPRITE_SIZE/2),
							SPRITE_SIZE/4, SPRITE_SIZE/4, this);
					break;
				...
				case MapEntitiesID.GREEN_TREE:
					if(season == WINTER) 
						g2.drawImage(SpriteLoader.loader.snow_tree, x * SPRITE_SIZE, y * SPRITE_SIZE,
							SPRITE_SIZE, SPRITE_SIZE, this);
					else if(season == FALL)
						g2.drawImage(SpriteLoader.loader.fall_tree, x * SPRITE_SIZE, y * SPRITE_SIZE,
								SPRITE_SIZE, SPRITE_SIZE, this);
					else
						g2.drawImage(SpriteLoader.loader.tree, x * SPRITE_SIZE, y * SPRITE_SIZE,
								SPRITE_SIZE, SPRITE_SIZE, this);
					break;
				case MapEntitiesID.BURNING_TREE:
					g2.drawImage(SpriteLoader.loader.burning_tree, x * SPRITE_SIZE, y * SPRITE_SIZE,
							SPRITE_SIZE, SPRITE_SIZE, this);
					break;
				case MapEntitiesID.ASHES:
					g2.drawImage(SpriteLoader.loader.ashes, x * SPRITE_SIZE, y * SPRITE_SIZE,
							SPRITE_SIZE, SPRITE_SIZE, this);
					break;
				default:
					break;
	...
	private void drawPath(Graphics2D g2, Agent player) {
		if (player.path != null) {
			g2.setColor(new Color(255, 201, 93));
			for (Position p : player.path) {
